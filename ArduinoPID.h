...
double theta[700]; //Rocket pitch angle
double runtime[700];


double torque[700];
double gimbal_angle[700]; //Gimbal Angle
...
double maxRotationPerStep = 10/0.1*time_step;  //TEMPORARY VALUE - 100ms/60deg - TO BE REPLACED WITH MEASURED VALUE
